    ...
    try:
        with open(input_file, 'r') as input_f:
            with open(output_file, 'w') as output_f:
                for line in input_f:
                    # Process the text here (for demonstration, we'll just copy the input to output)
                    output_f.write(line)
        ...
        print(f"Error: Permission denied while writing to output file '{output_file}'.")
        sys.exit(1)
    except Exception as e:
        print(f"An error occurred: {str(e)}")
        sys.exit(1)
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python your_program.py <input_file> <output_file>")
        sys.exit(1)
...
class TestFileProcessing(unittest.TestCase):
    ...
    def test_valid_files(self):
        ...
        subprocess.check_call(["python", "your_program.py", input_file, output_file])
    ...
    def test_permission_issue(self):
        # Test permission issue while writing to output file
        input_file = "test_input.txt"
        output_file = "/root/test_output.txt"  # Assuming root folder is not writable
